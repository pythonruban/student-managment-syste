...
listStd = ["ruban", "Tamil", "barath", "vasanth", "kishore", "vickey"]  # List Of Students
...
def runAgain():  # Making Runable Problem1353
    runAgn = input("\nwant To Run Again name/n: ")
    if (runAgn.lower() == 'name'):
        ...
        quit(bye)  # Print GoodBye Menssage And Exit The Program
